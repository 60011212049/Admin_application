...
List<BusstopModel> busstopModelFromJson(String str) => List<BusstopModel>.from(
    json.decode(str).map((x) => BusstopModel.fromJson(x)));

String busstopModelToJson(List<BusstopModel> data) =>
